...
# Plotting to PNG device
      ...
      par(mar=c(4,4,2,2))      
      par(mfrow = c(2, 2))                                                                                  #Set grid of plots
      
      # First plot
      plot(formattedDateTime,subPowerConsum$Global_active_power, type="l",xlab="",ylab="Global Active Power")
      
      # Second plot
      plot(formattedDateTime,subPowerConsum$Voltage, type="l",xlab="datetime",ylab="Voltage")
      ...
      # Fourth plot
      plot(formattedDateTime,subPowerConsum$Global_reactive_power, type="l",xlab="datetime",ylab="Global_reactive_power")
